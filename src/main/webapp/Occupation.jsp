<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	<%@include file="index.jsp" %>
			...
			<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-md-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<p class="card-description">Veuillez remplir tous les champs pour
									demander votre ocuppation d'une salle</p>
		...
		<script src="js/ocuppation.js"></script>
		</body>
